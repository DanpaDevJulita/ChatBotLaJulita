...
const { instalarSupabaseFalso, instalarModeloFalso, instalarBoldFalso, usarGuion, adaptadorFalso, enviados, registroDelModelo, sembrarMensajes, sembrarReservaParaCobrar, linksPedidosABold } = await import("./fakes.js");
