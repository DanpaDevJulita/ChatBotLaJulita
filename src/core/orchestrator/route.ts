...
import { openrouter, ORCHESTRATOR_MODEL } from "../llm/openrouter.js";

const ORQUESTADOR_PROMPT = fs.readFileSync(path.join(process.cwd(), "prompts", "orquestador.md"), "utf-8");
 ...
 */
// Notas de diseño del router (antes estaban DENTRO de prompts/orquestador.md, lo que se lo
